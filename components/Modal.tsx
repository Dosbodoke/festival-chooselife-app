  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          id="defaultModal"
          className="fixed top-0 right-0 left-0 bottom-0 z-50 flex justify-center items-center w-full md:inset-0 bg-gray-700 bg-opacity-50"
        >
                ...
                <div className="grid gap-4 mb-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      name="time"
                      id="time"
                      placeholder="Tempo da travessia"
                      required
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    />
                  </div>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      id="description"
                      rows={4}
                      placeholder="Registre sua opinião sobre a fita."
