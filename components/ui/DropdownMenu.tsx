...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-sm py-2 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-gray-500",
      className
    )}
    checked={checked}
    {...props}
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-sm py-2 pl-8 pr-2 text-sm text-gray-700 outline-none transition-colors focus:bg-gray-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:text-gray-50 dark:focus:bg-gray-500 dark:focus:text-white dark:data-[state=open]:bg-gray-500 dark:data-[state=open]:text-white",
      className
    )}
    {...props}
  >
