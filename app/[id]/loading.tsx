...
function loading() {
  return (
    <div className="mx-auto flex w-full max-w-screen-xl flex-1 items-center justify-center px-4 py-8 lg:px-6 lg:py-16">
      <div className="flex h-96 w-72 animate-pulse flex-wrap-reverse rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800 lg:w-4/5">
